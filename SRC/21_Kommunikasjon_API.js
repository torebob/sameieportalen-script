...
(() => {
  ...
  const handleTrackingPixelRequest = (e) => {
    try {
  ...
  globalThis.openNyttOppslagUI = openNyttOppslagUI;
  globalThis.getRecipientGroups = getRecipientGroups;
  globalThis.sendOppslag = sendOppslag;
  globalThis.handleTrackingPixelRequest = handleTrackingPixelRequest;
