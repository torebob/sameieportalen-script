...
/**
 * Henter innholdet i en fil for å inkludere det direkte i HTML.
 * @param {string} filnavn - Stien til filen, f.eks. 'public/assets/app.css'.
 * @returns {string} Innholdet i filen.
 */
